...
<?php
					...
					foreach($cons_row as $key => $cons_row) 
					{
						...
						<tr>
									...
									<td align="center"><?=$cons_row->payment_no?></td>
								...
								?>
									...
									<td>
										  		...
										  		<a href="<?=base_url().'index.php/consultant/consultancy_proposal_approve/edit_form3/'.$cons_row->sr_no.'/'.$cons_row->payment_no?>">
										  		
										  			<? 
										  			$ui->button()->icon($ui->icon('edit'))->uiType('primary')->mini()->value('Edit')->show(); ?>
									</td>
								</tr>
					<?
