					...
					foreach($details as $row)
						{
							if($row->status==103)
							{
								...
								<tr>
									...
									<td>
										<a href="<?=base_url().'index.php/consultant/consultant_disbursement_sheet/disbursement_form1/'.$row->sr_no?>">
											<?
												$ui->button()->uiType('primary')->mini()->value('Form 1')->show();
											?></a>
										<a href="<?=base_url().'index.php/consultant/consultant_disbursement_sheet/view_disbursement_prev/'.$row->sr_no?>">
											<?
												$ui->button()->uiType('primary')->mini()->value('Form 2')->show();
											?></a><br>
										<a href="<?=base_url().'index.php/consultant/consultant_disbursement_sheet/view_disbursement_prev/'.$row->sr_no?>">
											<?
												$ui->button()->uiType('primary')->mini()->value('Form 3')->show();
											?></a>
										<a href="<?=base_url().'index.php/consultant/consultant_disbursement_sheet/disbursement_form4/'.$row->sr_no?>">
											<?
												$ui->button()->uiType('primary')->mini()->value('Form 4')->show();
											?></a>			
									</td>
								</tr>
							<?}
