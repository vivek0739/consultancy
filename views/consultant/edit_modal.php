	...
	?>
		<thead>
			...
			<tr>
				...
				<td>
					<a href="<?=base_url().'index.php/consultant/edit_consultancy_form/edit_consultancy/'.$cons_row->sr_no?>" target="_blank"><? 
		  			echo '<span class="label label-success">Edit</span>';
				...
				<td align="center">
					...
					<a href="<?=base_url().'assets/files/information/circular/'.$cons_row->file_path?>" download="<?=$cons_row->file_path?>" target="_blank">
	...
	foreach ($form2 as $key => $action) {
		?>
			<tr>
				...
				<td>
					<a href="<?=base_url().'index.php/consultant/consultancy_proposal_form/edit/'.$cons_row->sr_no.'/'.$action->payment_no?>" target="_blank">
		  			<? 
		  			echo '<span class="label label-success">Edit</span>';
	...
	?>
		<thead>
			...
			<tr>
				...
				<td>
					<a href="<?=base_url().'index.php/consultant/consultant_disbursement_sheet/resubmit/'.$action->consultancy_no.'/'.$cons_row->sr_no?>" target="_blank"><? 
		  			echo '<span class="label label-success">Edit</span>';
