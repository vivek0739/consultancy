...
<?php
	...
	?>
		<thead>
			...
			<tr>
				...
				<td>
					<a href="<?=base_url().'index.php/consultant/consultant/view_consultancy_form_hod/'.$cons_row->sr_no.'/'.$auth_id?>" target="_blank">
	...
	if ($cons_row->modification_value != 0)
									...
									?>
										  		...
										  		<a href="<?=base_url().'index.php/consultant/consultant/view_consultancy_prev/'.$cons_row->sr_no.'/'.$auth_id?>" target="_blank">
	...
	foreach ($form2 as $key => $action) {
		?>
			<tr>
				...
				<td>
					<a href="<?=base_url().'index.php/consultant/consultancy_proposal_approve/index/'.$cons_row->sr_no.'/'.$action->payment_no.'/'.$auth_id?>" target="_blank">
		  			<? 
				...
				<td>
					...
					if ($action->modification_value != 0)
									...
									?>
										  		...
										  		<a href="<?=base_url().'index.php/consultant/consultancy_proposal_approve/view_proposal_prev/'.$cons_row->sr_no.'/'.$action->payment_no.'/'.$auth_id?>" target="_blank">
										  			<?
		...
		<a href="<?=base_url().'assets/files/consultant/DD/'.$action->file_path?>" download="<?=$action->file_path?>"><span class="label label-primary">download</span></a>
				...
				<td>
					<a href="<?=base_url().'index.php/consultant/consultancy_proposal_approve/view_receipt/'.$cons_row->sr_no.'/'.$action->payment_no?>" target="_blank">
		  			<? 
				...
				<td>
					...
					if ($action->modv!= 0)
									...
									?>
										  		...
										  		<a href="<?=base_url().'index.php/consultant/consultancy_proposal_approve/view_receipt_prev/'.$cons_row->sr_no.'/'.$action->payment_no?>" target="_blank">
										  			<?
...
*/
	...
	<button type="button" class="" data-dismiss="modal" aria-hideen="true">
							X</button>
	</div>
	<?
$test_box->close();
