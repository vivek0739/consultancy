		...
		$tabBox1 = $ui->tabBox()
			...
			$t4 = $ui->tabPane()->id("t4")->open();
						...
						/*$D1_box = $ui->box()
							...
							$ui->input()->label("Number Of Member")->id('member')->name('member')->placeholder('ex.-10 (limit 50)')->addonRight($ui->button()->value('Enter')->id('sub')->uiType('primary'))->show();
							$col0->close();
			...
			/********************TAB 5 OPEN*********************************/
					...
					/***************************************************************/
							...
							$ui->input()->label("Number Of Staff")->id('staff')->name('staff')->placeholder('ex.-10 (limit 50)')->addonRight($ui->button()->value('Enter')->id('sub1')->uiType('primary'))->show();
							$col0->close();
