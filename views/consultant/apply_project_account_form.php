...
<?php
					foreach($cons_row as $key => $cons_row1) 
					{
						...
						<tr>
									...
									<td align="center"><?=date('d M Y g:i a',strtotime($cons_row1->timestamp1)+19800)?></td>
								...
								?>
									...
									<td>
										  		...
										  		<a href="<?=base_url().'index.php/consultant/project_account/form/'.$cons_row1->sr_no.''?>">
