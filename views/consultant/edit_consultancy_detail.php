...
$('#form_submit').on('submit', function(e) {
    ...
    $('#gross_amount').on('keyup',function(){
           var service_tax = '<? echo $service_tax; ?>';
          service_tax = parseFloat(service_tax);
          service_tax = 1.0+service_tax/100;
                                ...
                                <? 
                                    ...
                                    if($cons_row->type_edc_fund=='pdp')
                                    {
                                         $ui->select()
                                                            ...
                                                            ->name('edc_fund')
                                                            ->id('edc_fund')
                                                            ->options(array($ui->option()->value('pdp')->text('In-house Executive Development')->selected(),
                                                                                $ui->option()->value('other_consult')->text('Other Consultancy')))
                                    ...
                                    else if($cons_row->type_edc_fund=='other_consult')
                                    {
                                         $ui->select()
                                                            ->name('edc_fund')
                                                            ->id('edc_fund')
                                                            ->options(array($ui->option()->value('pdp')->text('In-house Executive Development'),
                                                                                $ui->option()->value('other_consult')->text('Other Consultancy')->selected()))
                                    ...
                                    else
                                    {
                                     $ui->select()
                                                            ...
                                                            ->options(array($ui->option()->value('0')->text('Select Option')->selected()->disabled(),
                                                                                $ui->option()->value('pdp')->text('In-house Executive Development'),
                                                                                $ui->option()->value('other_consult')->text('Other Consultancy')))
