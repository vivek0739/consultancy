...
class Consultant_disbursement_details_model extends CI_Model
{
	...
	function insert_member_mod($data)
	{
	...
	function insert_staff_mod($data1)
	{
	...
	{
		$query=("SELECT * FROM consultancy_disbursement_member WHERE consultancy_disbursement_member.sr_no = '$sr_no' AND consultancy_disbursement_member.position='ci'");
		$query1=$this->db->query($query);
		return $query1->result();
	}
	function get_memo($sr_no)
	{
		$query=("SELECT consultancy_disbursement_member.*,user_details.*,departments.*,client_details.*
					...
					INNER JOIN client_details ON client_details.sr_no = '$sr_no'
					WHERE consultancy_disbursement_member.sr_no = '$sr_no' AND consultancy_disbursement_member.position='ci'");
		$query1=$this->db->query($query);
		return $query1->result();
	}
